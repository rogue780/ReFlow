...
class TestMangleModuleOnly(unittest.TestCase):
    """Module-only mangling: dots become underscores, fl_ prefix."""

    def test_single_component(self) -> None:
        self.assertEqual(mangle("main"), "fl_main")

    def test_two_components(self) -> None:
        self.assertEqual(mangle("math.vector"), "fl_math_vector")

    def test_three_components(self) -> None:
        self.assertEqual(mangle("pipeline.orders.csv"), "fl_pipeline_orders_csv")
...
class TestMangleModuleAndType(unittest.TestCase):
    ...
    def test_simple_type(self) -> None:
        self.assertEqual(mangle("math.vector", "Vec3"), "fl_math_vector_Vec3")

    def test_single_module_type(self) -> None:
        self.assertEqual(mangle("config", "DB"), "fl_config_DB")
...
class TestMangleModuleTypeAndMethod(unittest.TestCase):
    ...
    def test_method(self) -> None:
        self.assertEqual(
            ...
            "fl_math_vector_Vec3_dot",
        )

    def test_constructor(self) -> None:
        self.assertEqual(
            mangle("domain.order", "Order", "from_raw"),
            "fl_domain_order_Order_from_raw",
        )
...
class TestMangleTopLevelFunction(unittest.TestCase):
    ...
    def test_function(self) -> None:
        self.assertEqual(
            ...
            "fl_pipeline_orders_run",
        )

    def test_single_module_function(self) -> None:
        self.assertEqual(mangle("main", fn_name="entry"), "fl_main_entry")
...
class TestMangleReservedCIdentifiers(unittest.TestCase):
    """C reserved words are safe after fl_ prefix mangling."""

    def test_return_as_function_name(self) -> None:
        result = mangle("test", fn_name="return", file="t.flow", line=1, col=1)
        self.assertEqual(result, "fl_test_return")

    def test_int_as_function_name(self) -> None:
        result = mangle("test", fn_name="int", file="t.flow", line=1, col=1)
        self.assertEqual(result, "fl_test_int")

    def test_static_as_type_name(self) -> None:
        result = mangle("test", "static", file="t.flow", line=1, col=1)
        self.assertEqual(result, "fl_test_static")

    def test_while_as_function_name(self) -> None:
        result = mangle("test", fn_name="while", file="t.flow", line=1, col=1)
        self.assertEqual(result, "fl_test_while")

    def test_non_reserved_passes(self) -> None:
        result = mangle("test", fn_name="process")
        self.assertEqual(result, "fl_test_process")
...
class TestMangleBuiltinType(unittest.TestCase):
    ...
    def test_int(self) -> None:
        self.assertEqual(mangle_builtin_type("int"), "fl_int")

    def test_int64(self) -> None:
        self.assertEqual(mangle_builtin_type("int64"), "fl_int64")

    def test_float(self) -> None:
        self.assertEqual(mangle_builtin_type("float"), "fl_float")

    def test_float32(self) -> None:
        self.assertEqual(mangle_builtin_type("float32"), "fl_float32")

    def test_bool(self) -> None:
        self.assertEqual(mangle_builtin_type("bool"), "fl_bool")

    def test_byte(self) -> None:
        self.assertEqual(mangle_builtin_type("byte"), "fl_byte")

    def test_char(self) -> None:
        self.assertEqual(mangle_builtin_type("char"), "fl_char")

    def test_string(self) -> None:
        self.assertEqual(mangle_builtin_type("string"), "FL_String*")
