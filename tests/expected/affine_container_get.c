...
/* Source: tests/programs/affine_container_get.flow */
...
typedef struct fl_tests_affine_container_get_Token fl_tests_affine_container_get_Token;

typedef struct FL_Option_fl_tests_affine_container_get_Token FL_Option_fl_tests_affine_container_get_Token;

void _fl_destroy_fl_tests_affine_container_get_Token(void* _ptr);

void _fl_retain_fl_tests_affine_container_get_Token(void* _ptr);

fl_int fl_tests_affine_container_get_main(void);

struct fl_tests_affine_container_get_Token {
    FL_String* value;
    fl_int line;
};

struct FL_Option_fl_tests_affine_container_get_Token {
    fl_byte tag;
    fl_tests_affine_container_get_Token value;
};

FL_String* _fl_str_tests_affine_container_get_0 = NULL;

FL_String* _fl_str_tests_affine_container_get_1 = NULL;

FL_String* _fl_str_tests_affine_container_get_2 = NULL;

FL_String* _fl_str_tests_affine_container_get_3 = NULL;

FL_String* _fl_str_tests_affine_container_get_4 = NULL;

/* Flow: destructor for fl_tests_affine_container_get_Token */
void _fl_destroy_fl_tests_affine_container_get_Token(void* _ptr) {
    fl_tests_affine_container_get_Token* _s = ((fl_tests_affine_container_get_Token*)_ptr);
    fl_string_release(_s->value);
}

/* Flow: retainer for fl_tests_affine_container_get_Token */
void _fl_retain_fl_tests_affine_container_get_Token(void* _ptr) {
    fl_tests_affine_container_get_Token* _s = ((fl_tests_affine_container_get_Token*)_ptr);
    fl_string_retain(_s->value);
}

/* Flow: tests.affine_container_get.main */
fl_int fl_tests_affine_container_get_main(void) {
    FL_Array* tokens = fl_array_new(0, 0, NULL);
    fl_array_set_struct_handlers(tokens, _fl_destroy_fl_tests_affine_container_get_Token, _fl_retain_fl_tests_affine_container_get_Token);
    FL_String* name = fl_string_concat(_fl_str_tests_affine_container_get_0, _fl_str_tests_affine_container_get_1);
    fl_string_retain(name);
    fl_tests_affine_container_get_Token _fl_tmp_0 = (fl_tests_affine_container_get_Token){.value = name, .line = 1};
    FL_Array* _fl_old_1 = tokens;
    tokens = fl_array_push_sized(tokens, (&_fl_tmp_0), sizeof(fl_tests_affine_container_get_Token));
    if (_fl_old_1 != tokens) {
        fl_array_release(_fl_old_1);
    }
    FL_Option_fl_tests_affine_container_get_Token _fl_tmp_2 = FL_OPT_DEREF_AS(fl_array_get_safe(tokens, 0), fl_tests_affine_container_get_Token, FL_Option_fl_tests_affine_container_get_Token);
    if (_fl_tmp_2.tag == 1) {
        _fl_retain_fl_tests_affine_container_get_Token((&_fl_tmp_2.value));
    }
    FL_Option_fl_tests_affine_container_get_Token got = _fl_tmp_2;
    FL_Option_fl_tests_affine_container_get_Token _fl_tmp_3 = got;
    if (_fl_tmp_3.tag == 1) {
        fl_tests_affine_container_get_Token tok = _fl_tmp_3.value;
        FL_String* _fl_tmp_4 = tok.value;
        FL_String* _fl_tmp_5 = fl_conv_to_string__int(tok.line);
        FL_String* _fl_tmp_6 = fl_string_concat(_fl_tmp_4, _fl_str_tests_affine_container_get_2);
...
static void _fl_init_statics(void) {
    ...
    _fl_str_tests_affine_container_get_0 = fl_string_from_cstr("hel");
    _fl_str_tests_affine_container_get_0->refcount = 2147483647;
    _fl_str_tests_affine_container_get_1 = fl_string_from_cstr("lo");
    _fl_str_tests_affine_container_get_1->refcount = 2147483647;
    _fl_str_tests_affine_container_get_2 = fl_string_from_cstr(":");
    _fl_str_tests_affine_container_get_2->refcount = 2147483647;
    _fl_str_tests_affine_container_get_3 = fl_string_from_cstr("none");
    _fl_str_tests_affine_container_get_3->refcount = 2147483647;
    _fl_str_tests_affine_container_get_4 = fl_string_from_cstr("done");
    _fl_str_tests_affine_container_get_4->refcount = 2147483647;
}
...
int main(int argc, char** argv) {
    ...
    _fl_init_statics();
    return fl_tests_affine_container_get_main();
}
