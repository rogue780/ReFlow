...
void fl_tests_lambda_capture_main(void) {
    ...
    FL_String* _fl_tmp_4 = _fl_str_tests_lambda_capture_0;
    ...
    fl_int a = 3;
    fl_int b = 4;
    _fl_closure_tests_lambda_capture_main_1* _fl_tmp_6 = ((_fl_closure_tests_lambda_capture_main_1*)malloc(sizeof(_fl_closure_tests_lambda_capture_main_1)));
    _fl_tmp_6->a = a;
    _fl_tmp_6->b = b;
    FL_Closure* _fl_tmp_7 = ((FL_Closure*)malloc(sizeof(FL_Closure)));
    _fl_tmp_7->refcount = 1;
    _fl_tmp_7->fn = ((void*)_fl_clfn_tests_lambda_capture_main_1);
    _fl_tmp_7->env = ((void*)_fl_tmp_6);
    FL_Closure* compute = _fl_tmp_7;
    fl_closure_retain(compute);
    FL_Closure* _fl_tmp_8 = compute;
    fl_int r2 = ((fl_int (*)(void*, fl_int))_fl_tmp_8->fn)(_fl_tmp_8->env, 2);
    FL_String* _fl_tmp_9 = fl_int_to_string(r2);
    FL_String* _fl_tmp_10 = _fl_str_tests_lambda_capture_1;
