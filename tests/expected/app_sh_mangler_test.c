...
FL_String* fl_self_hosted_mangler_mangle_closure_frame(FL_String* mod, FL_String* fn_name, fl_int lambda_id) {
    FL_String* parts = fl_string_replace(mod, _fl_str_self_hosted_mangler_64, _fl_str_self_hosted_mangler_65);
    FL_String* _fl_tmp_14 = fl_string_concat(_fl_str_self_hosted_mangler_69, parts);
...
FL_String* fl_self_hosted_mangler_mangle_closure_fn(FL_String* mod, FL_String* fn_name, fl_int lambda_id) {
    FL_String* parts = fl_string_replace(mod, _fl_str_self_hosted_mangler_64, _fl_str_self_hosted_mangler_65);
    FL_String* _fl_tmp_20 = fl_string_concat(_fl_str_self_hosted_mangler_70, parts);
...
FL_String* fl_self_hosted_mangler_mangle_stream_wrapper(FL_String* mod, FL_String* fn_name, fl_int wrapper_id) {
    FL_String* parts = fl_string_replace(mod, _fl_str_self_hosted_mangler_64, _fl_str_self_hosted_mangler_65);
    FL_String* _fl_tmp_29 = fl_string_concat(_fl_str_self_hosted_mangler_72, parts);
    FL_String* _fl_tmp_30 = fl_string_concat(_fl_tmp_29, _fl_str_self_hosted_mangler_65);
    FL_String* _fl_tmp_31 = fl_string_concat(_fl_tmp_30, fn_name);
...
FL_String* fl_self_hosted_mangler_mangle_sort_wrapper(FL_String* mod, FL_String* fn_name, fl_int wrapper_id) {
    FL_String* parts = fl_string_replace(mod, _fl_str_self_hosted_mangler_64, _fl_str_self_hosted_mangler_65);
    FL_String* _fl_tmp_35 = fl_string_concat(_fl_str_self_hosted_mangler_73, parts);
    FL_String* _fl_tmp_36 = fl_string_concat(_fl_tmp_35, _fl_str_self_hosted_mangler_65);
    FL_String* _fl_tmp_37 = fl_string_concat(_fl_tmp_36, fn_name);
...
FL_String* fl_self_hosted_mangler_mangle_fanout_wrapper(FL_String* mod, FL_String* fn_name, fl_int fanout_id, fl_int branch_idx) {
    FL_String* parts = fl_string_replace(mod, _fl_str_self_hosted_mangler_64, _fl_str_self_hosted_mangler_65);
    FL_String* _fl_tmp_41 = fl_string_concat(_fl_str_self_hosted_mangler_74, parts);
    FL_String* _fl_tmp_42 = fl_string_concat(_fl_tmp_41, _fl_str_self_hosted_mangler_65);
    FL_String* _fl_tmp_43 = fl_string_concat(_fl_tmp_42, fn_name);
    FL_String* _fl_tmp_44 = fl_string_concat(_fl_tmp_43, _fl_str_self_hosted_mangler_65);
    FL_String* _fl_tmp_45 = fl_conv_to_string__int(fanout_id);
    FL_String* _fl_tmp_46 = fl_string_concat(_fl_tmp_44, _fl_tmp_45);
...
FL_String* fl_self_hosted_mangler_mangle_exception_frame(fl_int index) {
    FL_String* _fl_tmp_53 = fl_conv_to_string__int(index);
    return fl_string_concat(_fl_str_self_hosted_mangler_76, _fl_tmp_53);
}
...
FL_String* fl_self_hosted_mangler_mangle_monomorphized(FL_String* mod, FL_String* fn_name, FL_Array* type_args) {
    ...
    while (i < fl_array_len_int(type_args)) {
        ...
        FL_Option_ptr _fl_tmp_54 = fl_array_get_safe(type_args, i);
        fl_string_append((&suffix), ((_fl_tmp_54.tag == 1) ? _fl_tmp_54.value : _fl_str_self_hosted_mangler_63));
        fl_int _fl_e_1;
        FL_CHECKED_ADD(i, 1, &_fl_e_1);
        i = _fl_e_1;
    }
    FL_String* _fl_tmp_55 = fl_self_hosted_mangler_prefix();
    FL_String* _fl_tmp_56 = fl_string_concat(_fl_tmp_55, parts);
    FL_String* _fl_tmp_57 = fl_string_concat(_fl_tmp_56, _fl_str_self_hosted_mangler_65);
    FL_String* _fl_tmp_58 = fl_string_concat(_fl_tmp_57, fn_name);
    FL_String* _fl_tmp_59 = fl_string_concat(_fl_tmp_58, _fl_str_self_hosted_mangler_77);
    fl_string_release(_fl_tmp_55);
    fl_string_release(_fl_tmp_56);
    fl_string_release(_fl_tmp_57);
    fl_string_release(_fl_tmp_58);
    FL_String* _fl_ret_60 = fl_string_concat(_fl_tmp_59, suffix);
    fl_string_release(parts);
