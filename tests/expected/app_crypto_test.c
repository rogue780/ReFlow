...
FL_String* fl_crypto_do_digest(void* md_ptr, FL_String* data, fl_int digest_len) {
    ...
    if (fl_ptr_is_null(ctx)) {
        fl_string_retain(_fl_str_crypto_1);
...
int main(int argc, char** argv) {
    ...
    _fl_init_statics();
    return fl_tests_app_crypto_test_main();
}
