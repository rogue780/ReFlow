...
/* Source: tests/programs/affine_map.flow */
...
typedef struct fl_tests_affine_map_Token fl_tests_affine_map_Token;

FL_String* fl_conv_to_string__int64(fl_int64 val);

void _fl_destroy_fl_tests_affine_map_Token(void* _ptr);

void _fl_retain_fl_tests_affine_map_Token(void* _ptr);

fl_int fl_tests_affine_map_main(void);

struct fl_tests_affine_map_Token {
    FL_String* value;
    fl_int line;
};

FL_String* _fl_str_tests_affine_map_0 = NULL;

FL_String* _fl_str_tests_affine_map_1 = NULL;

FL_String* _fl_str_tests_affine_map_2 = NULL;

FL_String* _fl_str_tests_affine_map_3 = NULL;

FL_String* _fl_str_tests_affine_map_4 = NULL;
...
/* Flow: destructor for fl_tests_affine_map_Token */
void _fl_destroy_fl_tests_affine_map_Token(void* _ptr) {
    fl_tests_affine_map_Token* _s = ((fl_tests_affine_map_Token*)_ptr);
    fl_string_release(_s->value);
}

/* Flow: retainer for fl_tests_affine_map_Token */
void _fl_retain_fl_tests_affine_map_Token(void* _ptr) {
    fl_tests_affine_map_Token* _s = ((fl_tests_affine_map_Token*)_ptr);
    fl_string_retain(_s->value);
}

/* Flow: tests.affine_map.main */
fl_int fl_tests_affine_map_main(void) {
    FL_Map* _fl_tmp_0 = fl_map_new();
    fl_map_set_val_destructor(_fl_tmp_0, _fl_destroy_fl_tests_affine_map_Token, _fl_retain_fl_tests_affine_map_Token, sizeof(fl_tests_affine_map_Token));
    FL_Map* m = _fl_tmp_0;
    fl_string_retain(_fl_str_tests_affine_map_1);
    fl_tests_affine_map_Token* _fl_tmp_1 = ((fl_tests_affine_map_Token*)malloc(sizeof(fl_tests_affine_map_Token)));
    (*_fl_tmp_1) = (fl_tests_affine_map_Token){.value = _fl_str_tests_affine_map_1, .line = 1};
    FL_Map* _fl_old_2 = m;
    m = fl_map_set_str(m, _fl_str_tests_affine_map_0, ((void*)_fl_tmp_1));
    if (_fl_old_2 != m) {
        fl_map_release(_fl_old_2);
    }
    fl_string_retain(_fl_str_tests_affine_map_3);
    fl_tests_affine_map_Token* _fl_tmp_3 = ((fl_tests_affine_map_Token*)malloc(sizeof(fl_tests_affine_map_Token)));
    (*_fl_tmp_3) = (fl_tests_affine_map_Token){.value = _fl_str_tests_affine_map_3, .line = 2};
    FL_Map* _fl_old_4 = m;
    m = fl_map_set_str(m, _fl_str_tests_affine_map_2, ((void*)_fl_tmp_3));
    if (_fl_old_4 != m) {
        fl_map_release(_fl_old_4);
    }
    FL_String* _fl_tmp_5 = fl_conv_to_string__int64(fl_map_len(m));
    FL_String* _fl_tmp_6 = _fl_str_tests_affine_map_4;
...
static void _fl_init_statics(void) {
    ...
    _fl_str_tests_affine_map_0 = fl_string_from_cstr("a");
    _fl_str_tests_affine_map_0->refcount = 2147483647;
    _fl_str_tests_affine_map_1 = fl_string_from_cstr("hello");
    _fl_str_tests_affine_map_1->refcount = 2147483647;
    _fl_str_tests_affine_map_2 = fl_string_from_cstr("b");
    _fl_str_tests_affine_map_2->refcount = 2147483647;
    _fl_str_tests_affine_map_3 = fl_string_from_cstr("world");
    _fl_str_tests_affine_map_3->refcount = 2147483647;
    _fl_str_tests_affine_map_4 = fl_string_from_cstr("size: ");
    _fl_str_tests_affine_map_4->refcount = 2147483647;
}
...
int main(int argc, char** argv) {
    ...
    _fl_init_statics();
    return fl_tests_affine_map_main();
}
