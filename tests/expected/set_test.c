...
fl_int fl_tests_set_test_main(void) {
    ...
    FL_Map* sa = fl_string_set_from_array(_fl_tmp_12);
    FL_Array* _fl_tmp_13 = fl_array_new(2, sizeof(FL_String*), (FL_String*[]){_fl_str_tests_set_test_7, _fl_str_tests_set_test_8});
    fl_array_set_elem_type(_fl_tmp_13, 1);
    fl_string_retain(_fl_str_tests_set_test_7);
    fl_string_retain(_fl_str_tests_set_test_8);
    FL_Map* sb = fl_string_set_from_array(_fl_tmp_13);
