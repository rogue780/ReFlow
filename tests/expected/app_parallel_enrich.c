...
FL_String* fl_tests_app_parallel_enrich_format_result(fl_int score, FL_String* category, fl_int hash) {
    FL_String* _fl_tmp_0 = fl_conv_to_string__int(score);
    FL_String* _fl_tmp_1 = fl_string_concat(_fl_str_tests_app_parallel_enrich_3, _fl_tmp_0);
    FL_String* _fl_tmp_2 = fl_string_concat(_fl_tmp_1, _fl_str_tests_app_parallel_enrich_4);
    ...
    FL_String* _fl_ret_6 = fl_string_concat(_fl_tmp_4, _fl_tmp_5);
...
void fl_tests_app_parallel_enrich_main(void) {
    FL_Array* _fl_tmp_7 = fl_array_new(4, sizeof(FL_String*), (FL_String*[]){_fl_str_tests_app_parallel_enrich_6, _fl_str_tests_app_parallel_enrich_7, _fl_str_tests_app_parallel_enrich_8, _fl_str_tests_app_parallel_enrich_9});
    ...
    while (_fl_tmp_8 < fl_array_len(values)) {
        fl_int v = (*((fl_int*)fl_array_get_ptr(values, _fl_tmp_8)));
        fl_int _fl_tmp_9 = v;
        FL_FanoutBranch _fl_tmp_10[3];
        _fl_tmp_10[0].fn = _fl_fanout_tests_app_parallel_enrich_main_0_0;
        _fl_tmp_10[0].arg = ((void*)((fl_int64)_fl_tmp_9));
        _fl_tmp_10[1].fn = _fl_fanout_tests_app_parallel_enrich_main_0_1;
        _fl_tmp_10[1].arg = ((void*)((fl_int64)_fl_tmp_9));
        _fl_tmp_10[2].fn = _fl_fanout_tests_app_parallel_enrich_main_0_2;
        _fl_tmp_10[2].arg = ((void*)((fl_int64)_fl_tmp_9));
        fl_fanout_run(_fl_tmp_10, 3);
        fl_int _fl_tmp_11 = ((fl_int)((fl_int64)_fl_tmp_10[0].result));
        FL_String* _fl_tmp_12 = ((FL_String*)_fl_tmp_10[1].result);
        fl_int _fl_tmp_13 = ((fl_int)((fl_int64)_fl_tmp_10[2].result));
        fl_int _fl_tmp_14 = _fl_tmp_11;
        FL_String* _fl_tmp_15 = _fl_tmp_12;
        fl_int _fl_tmp_16 = _fl_tmp_13;
        FL_String* output = fl_tests_app_parallel_enrich_format_result(_fl_tmp_14, _fl_tmp_15, _fl_tmp_16);
        fl_string_retain(output);
        FL_Option_ptr _fl_tmp_17 = fl_array_get_safe(names, idx);
        FL_String* name = ((_fl_tmp_17.tag == 1) ? _fl_tmp_17.value : _fl_str_tests_app_parallel_enrich_11);
        fl_string_retain(name);
        FL_String* _fl_tmp_18 = fl_string_concat(name, _fl_str_tests_app_parallel_enrich_12);
        fl_println(fl_string_concat(_fl_tmp_18, output));
    ...
    FL_Coroutine* source = fl_coroutine_new_threaded(_fl_tmp_19, 64);
    fl_int j = 0;
    while (!fl_coroutine_done(source)) {
        FL_Option_ptr _fl_tmp_20 = fl_coroutine_next(source);
        ...
        if (_fl_tmp_22.tag == 1) {
            ...
            FL_Option_ptr _fl_tmp_23 = fl_array_get_safe(names, j);
            FL_String* name = ((_fl_tmp_23.tag == 1) ? _fl_tmp_23.value : _fl_str_tests_app_parallel_enrich_11);
            fl_string_retain(name);
            ...
            FL_String* _fl_tmp_24 = fl_string_concat(name, _fl_str_tests_app_parallel_enrich_14);
            FL_String* _fl_tmp_25 = fl_conv_to_string__int(score);
            FL_String* _fl_tmp_26 = fl_string_concat(_fl_tmp_24, _fl_tmp_25);
            FL_String* _fl_tmp_27 = fl_string_concat(_fl_tmp_26, _fl_str_tests_app_parallel_enrich_4);
            FL_String* _fl_tmp_28 = fl_string_concat(_fl_tmp_27, cat);
            FL_String* _fl_tmp_29 = fl_string_concat(_fl_tmp_28, _fl_str_tests_app_parallel_enrich_5);
            FL_String* _fl_tmp_30 = fl_conv_to_string__int(hash);
            fl_println(fl_string_concat(_fl_tmp_29, _fl_tmp_30));
