...
/* Source: tests/programs/ffi_math.flow */
...
extern fl_float floor(fl_float);

FL_String* fl_conv_to_string__float(fl_float val);

fl_float fl_main_my_sqrt(fl_float x);

fl_float fl_main_my_ceil(fl_float x);

fl_float fl_main_my_floor(fl_float x);
...
/* Flow: main.main */
void fl_main_main(void) {
    fl_println(fl_conv_to_string__float(fl_main_my_sqrt(9.0)));
    fl_println(fl_conv_to_string__float(fl_main_my_ceil(3.2)));
    fl_println(fl_conv_to_string__float(fl_main_my_floor(3.8)));
}
