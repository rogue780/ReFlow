...
FL_Array* fl_tests_app_grep_read_lines(FL_String* filepath) {
    ...
    FL_Option_ptr _fl_tmp_3 = f_opt;
    if (_fl_tmp_3.tag == 1) {
        void* f = _fl_tmp_3.value;
        while (fl_true) {
            FL_Option_ptr line_opt = fl_file_read_line(f);
            FL_Option_ptr _fl_tmp_4 = line_opt;
            if (_fl_tmp_4.tag == 1) {
                FL_String* line = _fl_tmp_4.value;
                FL_Array* _fl_old_5 = lines;
                lines = fl_array_push_ptr(lines, line);
                if (_fl_old_5 != lines) {
...
fl_int fl_tests_app_grep_search_and_print(FL_String* filepath, FL_String* pattern, fl_bool case_i, fl_bool invert) {
    ...
    while (idx < num_lines) {
        ...
        if (fl_tests_app_grep_matches_line(line, pattern, case_i, invert)) {
            ...
            FL_String* _fl_tmp_7 = fl_conv_to_string__int(_fl_e_2);
            FL_String* _fl_tmp_8 = fl_string_concat(_fl_tmp_7, _fl_str_tests_app_grep_1);
            FL_String* _fl_tmp_9 = fl_string_concat(_fl_tmp_8, line);
...
fl_int fl_tests_app_grep_search_with_context(FL_String* filepath, FL_String* pattern, fl_int before, fl_int after) {
    ...
    fl_int idx = 0;
    while (idx < num_lines) {
        FL_Option_ptr _fl_tmp_10 = fl_array_get_safe(lines, idx);
        FL_String* line = ((_fl_tmp_10.tag == 1) ? _fl_tmp_10.value : _fl_str_tests_app_grep_0);
        fl_string_retain(line);
        if (fl_tests_app_grep_matches_line(line, pattern, fl_false, fl_false)) {
            FL_Array* _fl_old_11 = match_indices;
            match_indices = fl_array_push_int(match_indices, idx);
            if (_fl_old_11 != match_indices) {
    ...
    while (mi < match_count) {
        FL_Option_int _fl_tmp_12 = fl_array_get_int(match_indices, mi);
        if (_fl_tmp_12.tag == 1) {
            fl_int line_idx = _fl_tmp_12.value;
            fl_int _fl_e_2;
            ...
            fl_int li = start;
            while (li <= range_end) {
                FL_Option_ptr _fl_tmp_13 = fl_array_get_safe(lines, li);
                FL_String* line = ((_fl_tmp_13.tag == 1) ? _fl_tmp_13.value : _fl_str_tests_app_grep_0);
                fl_string_retain(line);
                if (li == line_idx) {
                    fl_int _fl_e_7;
                    FL_CHECKED_ADD(li, 1, &_fl_e_7);
                    FL_String* _fl_tmp_14 = fl_conv_to_string__int(_fl_e_7);
                    FL_String* _fl_tmp_15 = fl_string_concat(_fl_tmp_14, _fl_str_tests_app_grep_1);
                    FL_String* _fl_tmp_16 = fl_string_concat(_fl_tmp_15, line);
                    ...
                    FL_String* _fl_tmp_17 = fl_conv_to_string__int(_fl_e_8);
                    FL_String* _fl_tmp_18 = fl_string_concat(_fl_tmp_17, _fl_str_tests_app_grep_3);
                    FL_String* _fl_tmp_19 = fl_string_concat(_fl_tmp_18, line);
