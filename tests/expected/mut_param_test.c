...
/* Source: tests/programs/mut_param_test.flow */
...
typedef struct fl_main_Point fl_main_Point;

void fl_main_move_point(fl_main_Point* p, fl_int dx, fl_int dy);

fl_int fl_main_main(void);

struct fl_main_Point {
    fl_int x;
    fl_int y;
};

/* Flow: main.move_point */
void fl_main_move_point(fl_main_Point* p, fl_int dx, fl_int dy) {
    fl_int _fl_e_1;
    FL_CHECKED_ADD(p->x, dx, &_fl_e_1);
    p->x = _fl_e_1;
    fl_int _fl_e_2;
    FL_CHECKED_ADD(p->y, dy, &_fl_e_2);
    p->y = _fl_e_2;
}
