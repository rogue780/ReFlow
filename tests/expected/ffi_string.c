...
/* Flow: main.main */
void fl_main_main(void) {
    fl_println(fl_main_round_trip(fl_string_from_cstr("hello")));
    fl_println(fl_main_round_trip(fl_string_from_cstr("")));
    fl_println(fl_main_round_trip(fl_string_from_cstr("Flow FFI")));
}
