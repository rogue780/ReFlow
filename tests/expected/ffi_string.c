...
/* Source: tests/programs/ffi_string.flow */
...
FL_String* fl_main_round_trip(FL_String* s);
...
/* Flow: main.round_trip */
FL_String* fl_main_round_trip(FL_String* s) {
    void* p = fl_string_to_cptr(s);
    fl_int len = fl_string_len(s);
    return fl_string_from_cptr(p, len);
}

/* Flow: main.main */
void fl_main_main(void) {
    fl_println(fl_main_round_trip(_fl_str_main_0));
    fl_println(fl_main_round_trip(_fl_str_main_1));
    fl_println(fl_main_round_trip(_fl_str_main_2));
}
