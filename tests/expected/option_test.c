...
void fl_tests_option_test_main(void) {
    ...
    if (_fl_tmp_0.tag == 1) {
        ...
        FL_String* _fl_tmp_1 = fl_int_to_string(v);
        FL_String* _fl_tmp_2 = _fl_str_tests_option_test_0;
    ...
    FL_Option_int _fl_tmp_4 = fl_tests_option_test_find_positive((-5));
    if (_fl_tmp_4.tag == 1) {
        fl_int v = _fl_tmp_4.value;
        FL_String* _fl_tmp_5 = fl_int_to_string(v);
        FL_String* _fl_tmp_6 = _fl_str_tests_option_test_0;
    ...
    FL_Option_int _fl_tmp_8 = fl_tests_option_test_find_positive((-1));
    fl_int val = ((_fl_tmp_8.tag == 1) ? _fl_tmp_8.value : 0);
    FL_String* _fl_tmp_9 = fl_int_to_string(val);
    ...
    FL_Option_int _fl_tmp_12 = fl_tests_option_test_find_positive(99);
    fl_int val2 = ((_fl_tmp_12.tag == 1) ? _fl_tmp_12.value : 0);
    FL_String* _fl_tmp_13 = fl_int_to_string(val2);
    FL_String* _fl_tmp_14 = _fl_str_tests_option_test_2;
    ...
    FL_Option_int _fl_tmp_16 = maybe;
    fl_int x = ((_fl_tmp_16.tag == 1) ? _fl_tmp_16.value : 0);
    FL_String* _fl_tmp_17 = fl_int_to_string(x);
    FL_String* _fl_tmp_18 = _fl_str_tests_option_test_3;
