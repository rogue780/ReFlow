...
/* Source: tests/programs/ffi_basic.flow */
...
fl_int fl_main_safe_abs(fl_int x);
...
/* Flow: main.main */
void fl_main_main(void) {
    fl_println(fl_conv_to_string__int(fl_main_safe_abs((-42))));
    fl_println(fl_conv_to_string__int(fl_main_safe_abs(0)));
    fl_println(fl_conv_to_string__int(fl_main_safe_abs(7)));
}
