...
fl_self_hosted_typechecker_InterfaceInfo fl_self_hosted_typechecker_empty_iface_info(FL_String* name) {
    fl_string_retain(name);
    fl_string_retain(_fl_str_self_hosted_typechecker_0);
    return (fl_self_hosted_typechecker_InterfaceInfo){.name = name, .type_param_names = fl_array_new(0, 0, NULL), .method_names = fl_array_new(0, 0, NULL), .method_types = fl_map_new(), .has_ctor = fl_false, .ctor_name = _fl_str_self_hosted_typechecker_0, .ctor_type_box = (fl_self_hosted_typechecker_TCTypeBox){.tc = (fl_self_hosted_typechecker_TCType){.tag = 23}}};
}
...
void fl_self_hosted_typechecker_rebuild_scope_map(fl_self_hosted_typechecker_TCState* s) {
    ...
    while (i < s->scope_count) {
        ...
        FL_String* n = ((_fl_tmp_1.tag == 1) ? _fl_tmp_1.value : _fl_str_self_hosted_typechecker_0);
        fl_string_retain(n);
...
FL_String* fl_self_hosted_typechecker_join_path(FL_Array* parts) {
    ...
    FL_String* result = ((_fl_tmp_11.tag == 1) ? _fl_tmp_11.value : _fl_str_self_hosted_typechecker_0);
    fl_string_retain(result);
    fl_int i = 1;
    while (i < n) {
