...
/* Source: tests/programs/affine_container.flow */
...
typedef struct fl_tests_affine_container_Token fl_tests_affine_container_Token;

void _fl_destroy_fl_tests_affine_container_Token(void* _ptr);

void _fl_retain_fl_tests_affine_container_Token(void* _ptr);

fl_int fl_tests_affine_container_main(void);

struct fl_tests_affine_container_Token {
    FL_String* value;
    fl_int line;
};

FL_String* _fl_str_tests_affine_container_0 = NULL;

FL_String* _fl_str_tests_affine_container_1 = NULL;

FL_String* _fl_str_tests_affine_container_2 = NULL;

/* Flow: destructor for fl_tests_affine_container_Token */
void _fl_destroy_fl_tests_affine_container_Token(void* _ptr) {
    fl_tests_affine_container_Token* _s = ((fl_tests_affine_container_Token*)_ptr);
    fl_string_release(_s->value);
}

/* Flow: retainer for fl_tests_affine_container_Token */
void _fl_retain_fl_tests_affine_container_Token(void* _ptr) {
    fl_tests_affine_container_Token* _s = ((fl_tests_affine_container_Token*)_ptr);
    fl_string_retain(_s->value);
}

/* Flow: tests.affine_container.main */
fl_int fl_tests_affine_container_main(void) {
    FL_Array* tokens = fl_array_new(0, 0, NULL);
    fl_array_set_struct_handlers(tokens, _fl_destroy_fl_tests_affine_container_Token, _fl_retain_fl_tests_affine_container_Token);
    fl_string_retain(_fl_str_tests_affine_container_0);
    fl_tests_affine_container_Token _fl_tmp_0 = (fl_tests_affine_container_Token){.value = _fl_str_tests_affine_container_0, .line = 1};
    FL_Array* _fl_old_1 = tokens;
    tokens = fl_array_push_sized(tokens, (&_fl_tmp_0), sizeof(fl_tests_affine_container_Token));
    if (_fl_old_1 != tokens) {
        fl_array_release(_fl_old_1);
    }
    fl_string_retain(_fl_str_tests_affine_container_1);
    fl_tests_affine_container_Token _fl_tmp_2 = (fl_tests_affine_container_Token){.value = _fl_str_tests_affine_container_1, .line = 2};
    FL_Array* _fl_old_3 = tokens;
    tokens = fl_array_push_sized(tokens, (&_fl_tmp_2), sizeof(fl_tests_affine_container_Token));
    if (_fl_old_3 != tokens) {
        fl_array_release(_fl_old_3);
    }
    FL_String* _fl_tmp_4 = fl_conv_to_string__int(fl_array_len_int(tokens));
    FL_String* _fl_tmp_5 = _fl_str_tests_affine_container_2;
...
static void _fl_init_statics(void) {
    ...
    _fl_str_tests_affine_container_0 = fl_string_from_cstr("hello");
    _fl_str_tests_affine_container_0->refcount = 2147483647;
    _fl_str_tests_affine_container_1 = fl_string_from_cstr("world");
    _fl_str_tests_affine_container_1->refcount = 2147483647;
    _fl_str_tests_affine_container_2 = fl_string_from_cstr("count: ");
    _fl_str_tests_affine_container_2->refcount = 2147483647;
}
...
int main(int argc, char** argv) {
    ...
    _fl_init_statics();
    return fl_tests_affine_container_main();
}
