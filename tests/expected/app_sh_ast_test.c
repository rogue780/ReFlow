...
fl_int fl_tests_programs_app_sh_ast_test_main(void) {
    ...
    FL_String* _fl_tmp_15 = fl_string_concat(_fl_str_tests_programs_app_sh_ast_test_14, fl_conv_to_string__int(fl_self_hosted_ast_pattern_id(p_bind)));
    ...
    FL_String* _fl_tmp_17 = fl_string_concat(_fl_str_tests_programs_app_sh_ast_test_18, fl_conv_to_string__int(fl_self_hosted_ast_expr_id(e_int)));
    fl_println(_fl_tmp_17);
    fl_string_release(_fl_tmp_17);
    FL_String* _fl_tmp_18 = fl_string_concat(_fl_str_tests_programs_app_sh_ast_test_19, fl_conv_to_string__int(fl_self_hosted_ast_expr_id(e_str)));
    ...
    FL_Array* call_args2 = fl_array_push_sized(call_args, (&_fl_tmp_22), sizeof(fl_self_hosted_ast_Expr));
    fl_self_hosted_ast_Expr _fl_tmp_23 = e_str;
    ...
    FL_String* _fl_tmp_28 = fl_string_concat(_fl_str_tests_programs_app_sh_ast_test_26, fl_conv_to_string__int(fl_self_hosted_ast_stmt_id(s_let)));
    fl_println(_fl_tmp_28);
    fl_string_release(_fl_tmp_28);
    FL_String* _fl_tmp_29 = fl_string_concat(_fl_str_tests_programs_app_sh_ast_test_27, fl_conv_to_string__int(fl_self_hosted_ast_stmt_id(s_ret)));
    fl_println(_fl_tmp_29);
    fl_string_release(_fl_tmp_29);
    FL_String* _fl_tmp_30 = fl_string_concat(_fl_str_tests_programs_app_sh_ast_test_28, fl_conv_to_string__int(fl_self_hosted_ast_stmt_id(s_expr)));
    fl_println(_fl_tmp_30);
    fl_string_release(_fl_tmp_30);
    FL_String* _fl_tmp_31 = fl_string_concat(_fl_str_tests_programs_app_sh_ast_test_29, fl_conv_to_string__int(fl_self_hosted_ast_stmt_id(s_brk)));
    ...
    fl_self_hosted_ast_Param _fl_tmp_32 = p1;
    FL_Array* fn_params_d2 = fl_array_push_sized(fn_params_d, (&_fl_tmp_32), sizeof(fl_self_hosted_ast_Param));
    ...
    fl_self_hosted_ast_Decl d_mod = (fl_self_hosted_ast_Decl){.tag = 0, .DModule = (fl_self_hosted_ast_Decl_DModule){.id = 61, .line = 1, .col = 1, .path = _fl_tmp_34}};
    ...
    FL_String* _fl_tmp_37 = fl_string_concat(_fl_str_tests_programs_app_sh_ast_test_35, fl_conv_to_string__int(fl_self_hosted_ast_decl_id(d_mod)));
    fl_println(_fl_tmp_37);
    fl_string_release(_fl_tmp_37);
    FL_String* _fl_tmp_38 = fl_string_concat(_fl_str_tests_programs_app_sh_ast_test_36, fl_conv_to_string__int(fl_self_hosted_ast_decl_id(d_imp)));
