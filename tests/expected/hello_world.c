...
FL_String* _fl_str_tests_hello_world_0 = NULL;

/* Flow: tests.hello_world.main */
void fl_tests_hello_world_main(void) {
    fl_println(_fl_str_tests_hello_world_0);
}
...
static void _fl_init_statics(void) {
    ...
    _fl_str_tests_hello_world_0 = fl_string_from_cstr("Hello, World!");
    _fl_str_tests_hello_world_0->refcount = 2147483647;
}
