...
_fl_state_0:;
    ...
    while (!frame->finished) {
        while (1) {
            FL_Option_ptr _fl_tmp_20 = fl_stream_next(frame->inbox);
            if (_fl_tmp_20.tag == 0) {
                break;
            }
            frame->s = ((FL_String*)_fl_tmp_20.value);
    ...
    frame->total = _fl_e_4;
    FL_String* _fl_tmp_21 = fl_conv_to_string__int(frame->p);
    FL_String* _fl_tmp_22 = fl_string_concat(_fl_tmp_21, _fl_str_tests_app_healthcheck_22);
    FL_String* _fl_tmp_23 = fl_conv_to_string__int(frame->f);
    FL_String* _fl_tmp_24 = fl_string_concat(_fl_tmp_22, _fl_tmp_23);
    FL_String* _fl_tmp_25 = fl_string_concat(_fl_tmp_24, _fl_str_tests_app_healthcheck_22);
    FL_String* _fl_tmp_26 = fl_conv_to_string__int(frame->w);
    FL_String* _fl_tmp_27 = fl_string_concat(_fl_tmp_25, _fl_tmp_26);
    FL_String* _fl_tmp_28 = fl_string_concat(_fl_tmp_27, _fl_str_tests_app_healthcheck_22);
    FL_String* _fl_tmp_29 = fl_conv_to_string__int(frame->total);
    frame->_state = 1;
    return (FL_Option_ptr){.tag = 1, .value = ((void*)((fl_uint64)fl_string_concat(_fl_tmp_28, _fl_tmp_29)))};
_fl_state_1:;
_fl_stream_done:;
    frame->_state = -1;
    return (FL_Option_ptr){.tag = 0, .value = NULL};
...
void fl_tests_app_healthcheck_main(void) {
    fl_int port = 39876;
    FL_Channel* _fl_tmp_30 = fl_channel_new(64);
    FL_Stream* _fl_tmp_31 = fl_stream_from_channel_nonblocking(_fl_tmp_30);
    FL_Stream* _fl_tmp_32 = fl_tests_app_healthcheck_mock_server(_fl_tmp_31, port);
    FL_Coroutine* _fl_tmp_33 = fl_coroutine_new_threaded(_fl_tmp_32, 64);
    fl_coroutine_set_input(_fl_tmp_33, _fl_tmp_30);
    FL_Coroutine* server = _fl_tmp_33;
    FL_Option_ptr _fl_tmp_34 = fl_coroutine_next(server);
    if (_fl_tmp_34.tag == 1) {
        FL_String* status = _fl_tmp_34.value;
    ...
    FL_Channel* _fl_tmp_35 = fl_channel_new(64);
    FL_Stream* _fl_tmp_36 = fl_stream_from_channel_nonblocking(_fl_tmp_35);
    FL_Stream* _fl_tmp_37 = fl_tests_app_healthcheck_result_aggregator(_fl_tmp_36);
    FL_Coroutine* _fl_tmp_38 = fl_coroutine_new_threaded(_fl_tmp_37, 64);
    fl_coroutine_set_input(_fl_tmp_38, _fl_tmp_35);
    FL_Coroutine* agg = _fl_tmp_38;
    FL_Array* urls = fl_array_new(0, 0, NULL);
    fl_array_set_elem_type(urls, 1);
    FL_String* _fl_tmp_39 = fl_conv_to_string__int(port);
    FL_String* _fl_tmp_40 = fl_string_concat(_fl_str_tests_app_healthcheck_25, _fl_tmp_39);
    FL_Array* _fl_old_41 = urls;
    urls = fl_array_push_ptr(urls, fl_string_concat(_fl_tmp_40, _fl_str_tests_app_healthcheck_26));
    if (_fl_old_41 != urls) {
        fl_array_release(_fl_old_41);
    }
    fl_string_release(_fl_tmp_39);
    fl_string_release(_fl_tmp_40);
    FL_String* _fl_tmp_42 = fl_conv_to_string__int(port);
    FL_String* _fl_tmp_43 = fl_string_concat(_fl_str_tests_app_healthcheck_25, _fl_tmp_42);
    FL_Array* _fl_old_44 = urls;
    urls = fl_array_push_ptr(urls, fl_string_concat(_fl_tmp_43, _fl_str_tests_app_healthcheck_27));
    if (_fl_old_44 != urls) {
    ...
    urls = fl_array_push_ptr(urls, fl_string_concat(_fl_tmp_46, _fl_str_tests_app_healthcheck_28));
    if (_fl_old_47 != urls) {
    ...
    FL_Array* _fl_old_50 = urls;
    urls = fl_array_push_ptr(urls, fl_string_concat(_fl_tmp_49, _fl_str_tests_app_healthcheck_29));
    if (_fl_old_50 != urls) {
    ...
    FL_String* _fl_tmp_51 = fl_conv_to_string__int(_fl_e_1);
    FL_String* _fl_tmp_52 = fl_string_concat(_fl_str_tests_app_healthcheck_25, _fl_tmp_51);
    FL_Array* _fl_old_53 = urls;
    urls = fl_array_push_ptr(urls, fl_string_concat(_fl_tmp_52, _fl_str_tests_app_healthcheck_30));
    if (_fl_old_53 != urls) {
    ...
    fl_int idx = 0;
    while (idx < 5) {
        FL_Option_ptr _fl_tmp_54 = fl_array_get_safe(urls, idx);
        FL_String* target_str = ((_fl_tmp_54.tag == 1) ? _fl_tmp_54.value : _fl_str_tests_app_healthcheck_31);
        fl_string_retain(target_str);
        FL_Array* parts = fl_string_split(target_str, _fl_str_tests_app_healthcheck_32);
        FL_Option_ptr _fl_tmp_55 = fl_array_get_safe(parts, 0);
        FL_String* host = ((_fl_tmp_55.tag == 1) ? _fl_tmp_55.value : _fl_str_tests_app_healthcheck_0);
        fl_string_retain(host);
        FL_Option_ptr _fl_tmp_56 = fl_array_get_safe(parts, 1);
        FL_Option_int _fl_tmp_57 = fl_conv_string_to_int(((_fl_tmp_56.tag == 1) ? _fl_tmp_56.value : _fl_str_tests_app_healthcheck_33));
        fl_int tport = ((_fl_tmp_57.tag == 1) ? _fl_tmp_57.value : 0);
        FL_Option_ptr _fl_tmp_58 = fl_array_get_safe(parts, 2);
        FL_String* url_path = ((_fl_tmp_58.tag == 1) ? _fl_tmp_58.value : _fl_str_tests_app_healthcheck_34);
        fl_string_retain(url_path);
        FL_Option_ptr _fl_tmp_59 = fl_array_get_safe(parts, 3);
        FL_Option_int _fl_tmp_60 = fl_conv_string_to_int(((_fl_tmp_59.tag == 1) ? _fl_tmp_59.value : _fl_str_tests_app_healthcheck_35));
        fl_int expected = ((_fl_tmp_60.tag == 1) ? _fl_tmp_60.value : 200);
        FL_String* _fl_tmp_61 = fl_string_concat(_fl_str_tests_app_healthcheck_36, url_path);
        fl_println(_fl_tmp_61);
        fl_string_release(_fl_tmp_61);
        ...
        if (setjmp(_fl_ef_0.jmp) == 0) {
            ...
            fl_tests_app_healthcheck_CheckStatus _fl_tmp_62 = status;
            switch (_fl_tmp_62.tag) {
                case 0: {
                    fl_int code = _fl_tmp_62.Pass.code;
                    FL_String* _fl_tmp_63 = fl_string_concat(_fl_str_tests_app_healthcheck_37, url_path);
                    FL_String* _fl_tmp_64 = fl_string_concat(_fl_tmp_63, _fl_str_tests_app_healthcheck_38);
                    FL_String* _fl_tmp_65 = fl_conv_to_string__int(code);
                    FL_String* _fl_tmp_66 = fl_string_concat(_fl_tmp_64, _fl_tmp_65);
                    FL_String* _fl_tmp_67 = fl_string_concat(_fl_tmp_66, _fl_str_tests_app_healthcheck_39);
                ...
                case 2: {
                    fl_int code = _fl_tmp_62.Warn.code;
                    FL_String* reason = _fl_tmp_62.Warn.reason;
                    FL_String* _fl_tmp_68 = fl_string_concat(_fl_str_tests_app_healthcheck_40, url_path);
                    FL_String* _fl_tmp_69 = fl_string_concat(_fl_tmp_68, _fl_str_tests_app_healthcheck_38);
                    FL_String* _fl_tmp_70 = fl_conv_to_string__int(code);
                    FL_String* _fl_tmp_71 = fl_string_concat(_fl_tmp_69, _fl_tmp_70);
                    FL_String* _fl_tmp_72 = fl_string_concat(_fl_tmp_71, _fl_str_tests_app_healthcheck_41);
                    FL_String* _fl_tmp_73 = fl_string_concat(_fl_tmp_72, reason);
                ...
                case 1: {
                    FL_String* msg = _fl_tmp_62.Fail.msg;
                    FL_String* _fl_tmp_75 = fl_string_concat(_fl_str_tests_app_healthcheck_42, url_path);
                    FL_String* _fl_tmp_76 = fl_string_concat(_fl_tmp_75, _fl_str_tests_app_healthcheck_38);
                    FL_String* _fl_tmp_77 = fl_string_concat(_fl_tmp_76, msg);
                    FL_String* _fl_tmp_78 = fl_string_concat(_fl_tmp_77, _fl_str_tests_app_healthcheck_39);
            ...
            if (_fl_ef_0.exception_tag == 0) {
                ...
                while (_fl_tmp_79 < 2) {
                    _fl_tmp_79 = (_fl_tmp_79 + 1);
                    FL_String* _fl_tmp_81 = fl_string_concat(_fl_str_tests_app_healthcheck_43, ex);
                    FL_String* _fl_tmp_82 = fl_string_concat(_fl_tmp_81, _fl_str_tests_app_healthcheck_44);
                    ...
                    if (setjmp(_fl_ef_0.jmp) == 0) {
                        fl_tests_app_healthcheck_CheckStatus status = fl_tests_app_healthcheck_check_url(host, tport, url_path, expected, 2000);
                        fl_tests_app_healthcheck_CheckStatus _fl_tmp_83 = status;
                        switch (_fl_tmp_83.tag) {
                            case 0: {
                                fl_int code = _fl_tmp_83.Pass.code;
                                FL_String* _fl_tmp_84 = fl_string_concat(_fl_str_tests_app_healthcheck_37, url_path);
                                FL_String* _fl_tmp_85 = fl_string_concat(_fl_tmp_84, _fl_str_tests_app_healthcheck_38);
                                FL_String* _fl_tmp_86 = fl_conv_to_string__int(code);
                                FL_String* _fl_tmp_87 = fl_string_concat(_fl_tmp_85, _fl_tmp_86);
                                FL_String* _fl_tmp_88 = fl_string_concat(_fl_tmp_87, _fl_str_tests_app_healthcheck_39);
                            ...
                            case 2: {
                                fl_int code = _fl_tmp_83.Warn.code;
                                FL_String* reason = _fl_tmp_83.Warn.reason;
                                FL_String* _fl_tmp_89 = fl_string_concat(_fl_str_tests_app_healthcheck_40, url_path);
                                FL_String* _fl_tmp_90 = fl_string_concat(_fl_tmp_89, _fl_str_tests_app_healthcheck_38);
                                FL_String* _fl_tmp_91 = fl_conv_to_string__int(code);
                                FL_String* _fl_tmp_92 = fl_string_concat(_fl_tmp_90, _fl_tmp_91);
                                FL_String* _fl_tmp_93 = fl_string_concat(_fl_tmp_92, _fl_str_tests_app_healthcheck_41);
                                FL_String* _fl_tmp_94 = fl_string_concat(_fl_tmp_93, reason);
                            ...
                            case 1: {
                                FL_String* msg = _fl_tmp_83.Fail.msg;
                                FL_String* _fl_tmp_96 = fl_string_concat(_fl_str_tests_app_healthcheck_42, url_path);
                                FL_String* _fl_tmp_97 = fl_string_concat(_fl_tmp_96, _fl_str_tests_app_healthcheck_38);
                                FL_String* _fl_tmp_98 = fl_string_concat(_fl_tmp_97, msg);
                                FL_String* _fl_tmp_99 = fl_string_concat(_fl_tmp_98, _fl_str_tests_app_healthcheck_39);
                ...
                FL_String* _fl_tmp_100 = fl_string_concat(_fl_str_tests_app_healthcheck_42, url_path);
                FL_String* _fl_tmp_101 = fl_string_concat(_fl_tmp_100, _fl_str_tests_app_healthcheck_38);
                FL_String* _fl_tmp_102 = fl_string_concat(_fl_tmp_101, ex);
                FL_String* _fl_tmp_103 = fl_string_concat(_fl_tmp_102, _fl_str_tests_app_healthcheck_45);
...
_fl_tmp_80:;
    ...
    FL_Option_ptr _fl_tmp_104 = fl_coroutine_next(agg);
    if (_fl_tmp_104.tag == 1) {
        FL_String* report_str = _fl_tmp_104.value;
        FL_Array* rparts = fl_string_split(report_str, _fl_str_tests_app_healthcheck_22);
        fl_println(_fl_str_tests_app_healthcheck_46);
        FL_Option_ptr _fl_tmp_105 = fl_array_get_safe(rparts, 0);
        FL_String* _fl_tmp_106 = fl_string_concat(_fl_str_tests_app_healthcheck_47, ((_fl_tmp_105.tag == 1) ? _fl_tmp_105.value : _fl_str_tests_app_healthcheck_33));
        fl_println(_fl_tmp_106);
        fl_string_release(_fl_tmp_106);
        FL_Option_ptr _fl_tmp_107 = fl_array_get_safe(rparts, 1);
        FL_String* _fl_tmp_108 = fl_string_concat(_fl_str_tests_app_healthcheck_48, ((_fl_tmp_107.tag == 1) ? _fl_tmp_107.value : _fl_str_tests_app_healthcheck_33));
        fl_println(_fl_tmp_108);
        fl_string_release(_fl_tmp_108);
        FL_Option_ptr _fl_tmp_109 = fl_array_get_safe(rparts, 2);
        FL_String* _fl_tmp_110 = fl_string_concat(_fl_str_tests_app_healthcheck_49, ((_fl_tmp_109.tag == 1) ? _fl_tmp_109.value : _fl_str_tests_app_healthcheck_33));
        fl_println(_fl_tmp_110);
        fl_string_release(_fl_tmp_110);
        FL_Option_ptr _fl_tmp_111 = fl_array_get_safe(rparts, 3);
        FL_String* _fl_tmp_112 = fl_string_concat(_fl_str_tests_app_healthcheck_50, ((_fl_tmp_111.tag == 1) ? _fl_tmp_111.value : _fl_str_tests_app_healthcheck_33));
