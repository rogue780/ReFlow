...
fl_bool fl_tests_app_json_query_is_array_index(FL_String* segment) {
    ...
    FL_Option_int64 _fl_tmp_2 = fl_conv_string_to_int64(segment);
    if (_fl_tmp_2.tag == 1) {
...
FL_Array* fl_tests_app_json_query_resolve_segment(fl_json_JsonValue val, FL_String* segment) {
    if (fl_string_eq(segment, fl_string_from_cstr("#"))) {
        FL_Option_fl_json_JsonValue _fl_tmp_6 = fl_tests_app_json_query_value_length(val);
        if (_fl_tmp_6.tag == 1) {
            fl_json_JsonValue v = _fl_tmp_6.value;
    ...
    if (fl_tests_app_json_query_is_array_index(segment)) {
        ...
        if (_fl_tmp_8.tag == 1) {
            ...
            FL_Option_fl_json_JsonValue _fl_tmp_9 = fl_json_get_index(val, idx);
            if (_fl_tmp_9.tag == 1) {
                fl_json_JsonValue v = _fl_tmp_9.value;
                return fl_array_new(1, sizeof(fl_json_JsonValue), (fl_json_JsonValue[]){v});
            } else {
                return fl_array_new(0, 0, NULL);
            }
    ...
    FL_Option_fl_json_JsonValue _fl_tmp_10 = fl_json_get(val, segment);
    if (_fl_tmp_10.tag == 1) {
    ...
    while (i < fl_array_len_int(segments)) {
        ...
        if (_fl_tmp_11.tag == 1) {
            ...
            while (j < fl_array_len_int(current)) {
                FL_Option_fl_json_JsonValue _fl_tmp_12 = FL_OPT_DEREF_AS(fl_array_get_safe(current, j), fl_json_JsonValue, FL_Option_fl_json_JsonValue);
                if (_fl_tmp_12.tag == 1) {
                    fl_json_JsonValue val = _fl_tmp_12.value;
...
void fl_tests_app_json_query_run_query(fl_json_JsonValue root, FL_String* query, fl_bool pretty) {
    ...
    while (i < fl_array_len_int(results)) {
        FL_Option_fl_json_JsonValue _fl_tmp_14 = FL_OPT_DEREF_AS(fl_array_get_safe(results, i), fl_json_JsonValue, FL_Option_fl_json_JsonValue);
        if (_fl_tmp_14.tag == 1) {
...
void fl_tests_app_json_query_main(void) {
    ...
    FL_Option_fl_json_JsonValue _fl_tmp_15 = fl_json_parse(test_json);
    if (_fl_tmp_15.tag == 1) {
        fl_json_JsonValue root = _fl_tmp_15.value;
